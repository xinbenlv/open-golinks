...
import { UnownedAvatar } from "../components/UnownedAvatar";
          ...
          <form className="auth-form" onSubmit={onSubmit}>
            <header className="edit-header">
              <div className="edit-identity">
                ...
                {state.link.ownerId !== null ? <OwnerAvatar key={state.link.ownerId} owner={state.link.owner} /> : <UnownedAvatar key={slug} slug={slug} onClaim={(ownerId, owner) => {
